...
$('#send-data').click(function (){//Affichage message quand clic sur bouton
    ...
    $(document).ready(() => {//Style pour le message de confirmation
        $('.confirmation').css({'background-color':'#72EA8B',
                                'padding':'20px',
                                'text-align':'center',
                                'margin-bottom':'30px', 
                                'font-family': 'Times New Roman, Times, serif',
   
    });//Dans ce code corrigé, les propriétés CSS sont passées sous forme d'objet avec des clés correspondant aux noms de propriétés CSS et des valeurs correspondant aux valeurs que vous souhaitez leur attribuer.
    });
});
