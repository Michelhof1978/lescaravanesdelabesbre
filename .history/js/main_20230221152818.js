...
$(() => {
    $('#formulaire').submit(function (e){// création événement jquery quand clic sur bouton
        e.preventDefault();

    });

$('#send-data').click(function (){//Ajout du message de confirmation quand on clic sur le bouton
    $('#formulaire').prepend('<p class = "confirmation">Votre message a bien été envoyé!</p>')
});

$('#formulaire').on('click', '.confirmation', function(){
    console.log('');
    $(this).remove();// supprimer le message de confirmation quand on clic dessus
});
