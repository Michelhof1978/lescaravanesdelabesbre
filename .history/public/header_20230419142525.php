...
<div class="pt-2 text-center border-bottom row">
     ...
     <div class="col-2">
      ...
      <div class=" navbar-brand fs-2 textLogo col-3" href="#">Les Caravanes De La Besbre <span class="orange">.</span></div> 
      
    <div class="col-3">  <img src="../images/papillons.gif" alt="Papillons" style="height:100px " class="img-fluid"></div>
    </div>
    </div>
