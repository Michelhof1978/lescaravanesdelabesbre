    ...
    <div class="row">
      ...
      <div class="col-lg-6 mb-3">
        <div class="text-center">
          <img src="../images/festiDomp.webp" alt="logo festi domp" loading="lazy" class="img-fluid w-75 text-center mb-3 rounded-2">
        ...
        <div class="videoPal embed-responsive embed-responsive-4by3">
          <figure>
            ...
            <figcaption class="text-center">Concert Festi Domp 1ère Partie</figcaption>
          </figure>
        </div>

        <div class="videoPal embed-responsive embed-responsive-4by3 mt-5">
          <figure>
            <video controls class="embed-responsive-item videoPal1" src="../videos/festi04.mp4">
                Votre navigateur ne prend pas en charge la lecture de la vidéo.
            </video>
            <figcaption class="text-center">Concert Festi Domp 2ème Partie</figcaption>
          </figure>
        </div>

        <!-- Ajout des 5 nouvelles vidéos -->
        <div class="videoPal embed-responsive embed-responsive-4by3 mt-5">
          <figure>
            <video controls class="embed-responsive-item videoPal1" src="../videos/nouvelle_video1.mp4">
                Votre navigateur ne prend pas en charge la lecture de la vidéo.
            </video>
            <figcaption class="text-center">Nouvelle Vidéo 1</figcaption>
          </figure>
        </div>

        <div class="videoPal embed-responsive embed-responsive-4by3 mt-5">
          <figure>
            <video controls class="embed-responsive-item videoPal1" src="../videos/nouvelle_video2.mp4">
                Votre navigateur ne prend pas en charge la lecture de la vidéo.
            </video>
            <figcaption class="text-center">Nouvelle Vidéo 2</figcaption>
          </figure>
        </div>

        <div class="videoPal embed-responsive embed-responsive-4by3 mt-5">
          <figure>
            <video controls class="embed-responsive-item videoPal1" src="../videos/nouvelle_video3.mp4">
                Votre navigateur ne prend pas en charge la lecture de la vidéo.
            </video>
            <figcaption class="text-center">Nouvelle Vidéo 3</figcaption>
          </figure>
        </div>

        <div class="videoPal embed-responsive embed-responsive-4by3 mt-5">
          <figure>
            <video controls class="embed-responsive-item videoPal1" src="../videos/nouvelle_video4.mp4">
                Votre navigateur ne prend pas en charge la lecture de la vidéo.
            </video>
            <figcaption class="text-center">Nouvelle Vidéo 4</figcaption>
          </figure>
        </div>

        <div class="videoPal embed-responsive embed-responsive-4by3 mt-5">
          <figure>
            <video controls class="embed-responsive-item videoPal1" src="../videos/nouvelle_video5.mp4">
                Votre navigateur ne prend pas en charge la lecture de la vidéo.
            </video>
            <figcaption class="text-center">Nouvelle Vidéo 5</figcaption>
          </figure>
        </div>
      ...
      <div class="col-lg-6">
        <div class="">
          <img src="../images/laMontagne.webp" loading="lazy" alt="logo journal la montagne" class="img-fluid mb-lg-5 rounded-2">
        </div>
        ...
        <div class="ms-lg-5">
          <img src="../images/festi03.webp" loading="lazy" alt="concert festiDomp" class="videoPal embed-responsive embed-responsive-16by9 ms-5 img-fluid mb-5 text-center w-75 rounded-2">
          <img src="../images/festi02.webp" loading="lazy" alt="concert festiDomp" class="videoPal embed-responsive embed-responsive-16by9 ms-5 img-fluid mb-5 text-center w-75 rounded-2">
        </div>
