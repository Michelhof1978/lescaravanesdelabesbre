...
<div><iframe class="text-md-start  embed-responsive-item videoPal1" width="450" height="300" src="https://www.youtube.com/embed/PWIjFCqQw78" title="YouTube video player"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
  <div class="text-md-center"> <h3 class="achatBillet text-dark  " href="https://www.lepal.com/">Billeterie <br> <img src="../images/lePal.png" class="img-fluid w-25" /></h3> </div>
   
  <div> <iframe class="text-md-end align-items-end embed-responsive-item align-items-center videoPal2 text-right" width="450" height="300" src="https://www.youtube.com/embed/m7PrIAN_Krs" title="YouTube video player"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
</section>
</div>
