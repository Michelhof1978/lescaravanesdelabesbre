...
<h4 class="m-5 text-center border border-3 rounded  text-white p-2 display-6 h4Index" id="contact"><strong>LE CAMPING</strong></h4>
...
<div class="container-fluid ">
    ...
    <h4 class="m-5 text-center border border-3 rounded  text-white p-2 display-6 h4Index" id="contact"><strong>NOS CARAVANES</strong></h4>
