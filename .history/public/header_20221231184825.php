...
<!-- 
   <div class="row">
    ...
    <div class=" col-3"><img src="../images/logo.png" alt="Logo" width="100" height="130" ></div>
  <div class=" col-6 ps-auto pt-6 navbar-brand fs-2" href="#">Les Caravanes De La Besbre <span class="orange">.</span></div>
   -->

   <div class="p-0"><img src="../images/logo1.png" alt="Logo" width="450" height="130" ></div>
