<?php include("header.php") ?>
    ...
    <h1 class=" pb-2 text-center  border border-3 rounded bg-light m-2"> Location Hèbergements Proche Du parc D'Attraction Le Pal Dans L'Allier</h1>
    ...
    <div class="col-sm-12 col-xl-6 mt-4 ">
        <p class="textIntro lead bg-light rounded shadow p-4 mb-5 bg-white rounded ms-1 me-1 banner">
