    ...
    <div class="col-lg-4 col-md-12 mb-4">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <p class="tarifs"><strong>A partir 82,00 €</strong></p>
          <p class="card-text">
         ...
         <br> <p>Option d'hébergement sous le auvent, permettant d'accueillir 2 personnes supplémentaires pour 12,00 € par personne (matelas non fournis, veuillez prévoir).</p>
        </p>
      ...
      <div class="card">
        ...
        <div class="card-body">
         ...
         <br>
          ...
          Linge de lit non inclus, prévoir des draps de dimensions <strong>140/190 et 100/180</strong>. 
          <br>Tarifs <strong>82,00 €</strong> en semaine / <strong>89,00 €</strong> week-end, jours fériés et ponts.
          <br> <p>Option d'hébergement sous le auvent, permettant d'accueillir 2 personnes supplémentaires pour <strong></strong> 12,00 € par personne (matelas non fournis, veuillez prévoir).</p>
        </p>
