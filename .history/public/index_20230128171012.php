<?php include("header.php") ?>
  ...
  <nav role="navigation">
    <div class="py-3 text-center border-bottom">
      <img src="../images/logo.png" alt="" style="height:160px " class="invert img-fluid">
  ...
  <div class="navbar-expand-md ">
    <div class=" text-center my-2 ">
      ...
      <button class="navbar-toggler w-75" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon hamburger  " ></span> <span class="align-middle">Menu </span>
      </button>
    </div>
    ...
    <h1 class=" pb-2 text-center  border border-3 rounded bg-light m-2"> Location d'Hèbergements Proche Du parc D'Attraction Le Pal Dans L'Allier</h1>
    ...
    <img src="../images/bannerIntro.jpg" class="img-fluid" />
    </div>
...
<h4 class="mb-4 carouseTitle border border-3 rounded bg-light p-2 display-6  m-2 text-center">VENEZ DECOUVRIR LA BEAUTE DE LA CAMPAGNE</h4>
