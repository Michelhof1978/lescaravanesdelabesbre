...
<div class="container-fluid">
  ...
  <!-- Création hamburger en responsive -->
    <div class="navbar-toggler justify-content-center" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
      <span class="navbar-toggler-icon"></span>
    </div>

    <div class="row">
    <div class="collapse navbar-collapse justify-content-end custom-line " id="navbarNav"><!-- id appel la fonction hamburger de boostrap aria-controls -->
