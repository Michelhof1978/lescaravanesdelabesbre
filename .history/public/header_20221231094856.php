...
<nav class="navbar navbar-expand-md bg-body-tertiary">
  ...
  <div class="row">  
    <div class="col-1"><img src="../images/logo.png" alt="Logo" width="150" height="130" class="d-inline-block align-text-top "></div>
  <div class="col-11"><a class="navbar-brand  fs-2   " href="#">Les Caravanes De La Besbre <span class="orange">.</span></a></div>
  </div>
