...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  ...
  <div class="row">  
    <div class="col-sm-6"><img src="../images/logo.png" alt="Logo" width="150" height="130" class="d-inline-block align-text-top "></div>
  <div class="col-sm-6"><a class="navbar-brand p-3 fs-2   " href="#">Les Caravanes De La Besbre <span class="orange">.</span></a></div>
