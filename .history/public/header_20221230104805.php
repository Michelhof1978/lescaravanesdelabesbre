...
<nav class="navbar navbar-expand-lg bg-light ">
    ...
    <div class="col">  <img src="../images/logo.png" alt="Logo" width="150" height="130" class="d-inline-block align-text-top"></div>
     <div class="navbar-brand fs-2 col-5">Les Caravanes De La Besbre<span class="orange">.</span></div>
    ...
    <div class="collapse navbar-collapse col align-items-endzzzzz" id="navbarNav">
      <ul class="navbar-nav"> 
        <li class="nav-item">
