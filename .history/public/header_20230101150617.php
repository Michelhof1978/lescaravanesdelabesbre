...
<header class="text-center mT-0 p-0 img-fluid" style="background-image:url(../images/banner3.png); background-size:cover; background-position:center; height: 520px; width:100%">
