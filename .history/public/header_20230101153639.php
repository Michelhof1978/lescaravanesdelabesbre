...
<header class="text-center p-0 img-fluid" style="background-image:url(../images/banner3.png); background-size:cover; background-position:center; height: 560px; width:100%">
