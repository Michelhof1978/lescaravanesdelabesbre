            ...
            <div class="row">
                ...
                <div class="col-lg-6 pb-lg-5">
                    <div class="about-text bg-white p-lg-5 my-lg-5">
                        ...
                        Vous êtes une famille nombreuse ou un groupe de 8 à 12 personnes et vous cherchez un endroit confortable pour votre séjour au parc d'attractions Le Pal? Nous avons la solution pour vous! Nous proposons la location de trois caravanes adjacentes pour répondre à vos besoins. Avec notre équipe à votre disposition, nous ferons tout notre possible pour que votre séjour soit une réussite.
                        <div class="row mb-4">
                            <div class="col-6">
