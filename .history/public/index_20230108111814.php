  ...
  <main class="mt-3">
    <div class="container">
      ...
      <div class="col-sm-1"><iframe class="videoPal1" width="450" height="300" src="https://www.youtube.com/embed/PWIjFCqQw78" title="YouTube video player"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
        ...
        <div class="col-sm-2 text-center logoBilletGroup"> <h3 class="billeterie text-dark ">Billeterie <a href="https://www.lepal.com/"> <img src="../images/lePal.png" class="achatBillet img-fluid " /></h3> </a> </div>
