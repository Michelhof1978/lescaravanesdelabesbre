...
<div class="container ">
<div id="carouselExampleCaptions" class="carousel slide mt-5 carousel carouselIndex">

<div class="carousel-indicators carouselIndex">
...
<div class="carousel-inner carouselIndex">
  <div class="carousel-item active carouselIndex ">
...
<button class="carousel-control-prev carouselIndex" type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide="prev">
  <span class="carousel-control-prev-icon carouselIndex" aria-hidden="true"></span>
  <span class="visually-hidden">Previous</span>
</button>

<button class="carousel-control-next carouselIndex" type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide="next">
  <span class="carousel-control-next-icon carouselIndex" aria-hidden="true"></span>
