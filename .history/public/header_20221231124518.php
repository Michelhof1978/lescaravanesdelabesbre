...
<div class="container-fluid">
  ...
  <!-- Création hamburger en responsive -->
    <div class="navbar-toggler col-12 center" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
      <span class="navbar-toggler-icon "></span>
    </div>

    
    <d class="collapse navbar-collapse  custom-line mx-5 " id="navbarNav"><!-- id appel la fonction hamburger de boostrap aria-controls -->
