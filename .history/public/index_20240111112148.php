        ...
        <div class="col-lg-4 col-md-12 mb-4">
            <div class="card">
                <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                    <img src="../images/caravane1.webp" alt="Caravane BIG - Hébergement pour 4 personnes" loading="lazy" onmouseover="zoomIn(this)" onmouseout="zoomOut(this)" class="img-fluid rounded-3 mt-2">
                </div>
          <div class="card-body">
...
<a href="<?php echo AIRBNB1_URL; ?>" target="_blank" class="btn btn-primary">Réservez Sur Airbnb (Tarifs Majorés de 20%) !</a>
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="card">
          <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
            <img src="../images/caravane2.webp" alt="Hébergements le pal" loading="lazy" onmouseover="zoomIn(this)" onmouseout="zoomOut(this)" class="img-fluid rounded-3 mt-2">
          </div>
          <div class="card-body">
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="card">
          <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
            <img src="../images/caravane3.webp" alt="hôtel le pal" loading="lazy" onmouseover="zoomIn(this)" onmouseout="zoomOut(this)" class="img-fluid rounded-3 mt-2">
            <a href="#!">
