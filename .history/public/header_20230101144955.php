...
<div class=" row  d-flex align-items-start">
    <div class="col-3  p-0"><img src="../images/logo.png" alt="Logo" width="auto" height="auto" ></div>
...
<header class="text-center p-5 img-fluid" style="background-image:url(../images/banner3.png); background-size:cover; background-position:center; max-width: 100%; height: auto; width:100%">
