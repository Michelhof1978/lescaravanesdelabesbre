<?php include("header.php") ?>
    ...
    <h1 class=" pb-2 text-center  border border-3 rounded bg-success h1Index pt-1 text-whitebg-gradient" style="background: linear-gradient(to right, #4b6cb7, #182848);"> Location d'Hèbergements Proche Du parc D'Attraction Le Pal Dans L'Allier</h1>
