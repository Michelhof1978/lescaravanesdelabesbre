...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  ...
  <div class="row">  <img src="../images/logo.png" alt="Logo" width="150" height="130" class="d-inline-block align-text-top menu"></div>
  <a class="navbar-brand fs-2 pb-4 col-4 menu" href="#">Les Caravanes De La Besbre <span class="orange">.</span></a>
