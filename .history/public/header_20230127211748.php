...
<ul class="navbar-nav fs-5 px-5">
  ...
  <li class="nav-item navbar">
    <a class="nav-link navbar" aria-current="page" href="index.php">Accueil</a>
  </li>
  <li class="nav-item navbar">
    <a class="nav-link navbar" href="informations.php">Informations</a>
  </li>
  <li class="nav-item navbar">
    <a class="nav-link navbar" href="tourisme.php">Tourisme</a>
  </li>
  <li class="nav-item navbar">
    <a class="nav-link navbar" href="https://www.lepal.com/">Vente Billets</a>
  </li>
  <li class="nav-item ">
    <a class="nav-link navbar" #contact  href="#contact">Contact</a>
  </li>
