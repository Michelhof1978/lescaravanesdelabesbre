        ...
        <div class="row d-flex justify-content-center">
            <div class="col-md-6">
                ...
                <div class="form-outline mb-4">
                    ...
                    <input name="nombreEnfants" type="number" id="nombreEnfants" class="form-control" placeholder="Nombre d'enfants" required>
...
<script>
        ...
        function ajouterChampsDateNaissance() {
            ...
            var containerDatesNaissance = document.getElementById("containerDatesNaissance");

            // Effacez les champs existants
            containerDatesNaissance.innerHTML = "";

            // Ajoutez les nouveaux champs en fonction du nombre d'enfants
            for (var i = 1; i <= nombreEnfants; i++) {
