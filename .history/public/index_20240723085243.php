...
<section class="index text-center clear mt-4 ms-2 me-2">
  ...
  <section class="center-section mt-5 ms-5 container">
    <div class="offre-container d-flex align-items-center">

        <div class="offre me-4">
            <img src="images/offre2024.png" alt="robot" loading="lazy" class="img-fluid w-100">
        </div>

        <div class="textIntro w-50">
            <p>
  ...
  <div class="text-center">
    ...
    <div class="row g-0 flex-column flex-md-row">
        ...
        <div class="col text-center align-self-center">
            <h2 class="text-dark display-6">Billeterie </h2>
