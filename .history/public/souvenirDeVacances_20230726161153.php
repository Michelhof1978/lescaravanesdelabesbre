...
<iframe class="embed-responsive-item videoPal1" src="../videos/festi01.mp4" frameborder="0" allowfullscreen></iframe>
        </div>
       
        <div class="videoPal embed-responsive embed-responsive-16by9 ms-5 mt-5">
<iframe class="embed-responsive-item videoPal1" src="../videos/festi04.mp4" frameborder="0" allowfullscreen></iframe>
        </div>
...
<div class="lead mt-5 text-center bg-light rounded shadow p-4 pb-5 bg-white rounded ms-1 me-1 mb-5">
        ...
        <img src="../images/festi0.webp" alt="concert festiDomp"  class="videoPal embed-responsive embed-responsive-16by9 ms-5 img-fluid mb-5 text-center w-50" /> 
