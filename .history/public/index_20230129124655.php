<?php include("header.php") ?>
    ...
    <h1 class=" pb-2 text-center  border border-3 rounded bg-info h1Index pt-2 text-white"> Location d'Hèbergements Proche Du parc D'Attraction Le Pal Dans L'Allier</h1>
