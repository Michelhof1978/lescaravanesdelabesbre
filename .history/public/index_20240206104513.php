    ...
    <div class="col-lg-4 col-md-12 mb-4">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <p class="card-text">
          <p>Tarif pour 4 personnes max (2 adultes avec 2 enfants) avec la possibilité de louer simultanément plusieurs caravanes pour accueillir des familles nombreuses.<br>
          ...
          <br>Tarifs <strong>82,00 €</strong> la nuitée en semaine / <strong>89,00 €</strong> la nuitée le week-end, jours fériés et ponts.</p>
