...
<script>
    ...
    // Création de la div pour afficher le message
    var messageDiv = document.createElement("div");
    messageDiv.style.position = "fixed";
    messageDiv.style.top = "60%";
    messageDiv.style.left = "50%";
    messageDiv.style.transform = "translate(-50%, -50%)";
    messageDiv.style.zIndex = "10000"; //Pour afficher au-dessus de tout élément
    ...
    // Ajout de la div du message au body de la page
