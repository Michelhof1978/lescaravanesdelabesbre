...
.meteoContainer {
background-color: rgba(239, 109, 17, 0.295);
border: 5px solid rgb(17, 150, 239);
}
...
<img src="../images/pal50Ans.webp" alt="Plan le pal" title="Plan du Pal" class="logoPal img-fluid" /> 
</a>
<h3 class="mt-3">Téléchargez le plan !</h3>
</div>

<div class="meteoContainer  col-4 text-center pt-2">
<h2>Météo du jour  <strong><?php echo $name; ?></strong></h2>
                    <?php 
                        switch($weather)
                        {
                            case "Clear":
