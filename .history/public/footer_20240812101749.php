...
<p class="color-weight" style="color: white; text-align: center;">
    ...
    <a class="text-dark" href="<?php echo AUTHOR_URL; ?>" target="_blank" style="display: inline-flex; align-items: center; justify-content: flex-end;">
        Harmony Digital - Droits réservés
        <img src="../images/logoharmony.png" alt="Logo" style="vertical-align: middle; margin-left: 10px; width: 70px; height: auto;">
    </a>
</p>
