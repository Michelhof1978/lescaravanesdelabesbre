    ...
    window.addEventListener("load", function(){
        window.cookieconsent.initialise({
            ...
            "content": {
                ...
                "allow": "Accepter",
                "link": "En savoir plus",
                "href": "/politique-cookies" // Mettez ici le lien vers votre page de politique de cookies
            },
            "elements": {
                "allow": '<button style="cursor:pointer; margin-right: 10px;" aria-label="allow cookies">Accepter</button>',
                "dismiss": '<button style="cursor:pointer;" aria-label="refuse cookies">Refuser</button>'
            },
            "onInitialise": function(status) {
                // Ajoutez votre code ici lors de l'initialisation du cookie consent
            },
            "onStatusChange": function(status) {
                if (status === "allow") {
                    // Ajoutez votre code ici lorsque les cookies sont acceptés
                } else if (status === "dismiss") {
                    // Ajoutez votre code ici lorsque les cookies sont refusés
                }
            }
        });
    });
