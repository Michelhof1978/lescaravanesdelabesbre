        ...
        <div class="col-lg-4 col-md-12 mb-4">
            <div class="card">
                <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                    <img src="../images/caravane1.webp" alt="Caravane BIG - Hébergement pour 4 personnes" loading="lazy" onmouseover="zoomIn(this)" onmouseout="zoomOut(this)" class="img-fluid rounded-3 mt-">
                </div>
          <div class="card-body">
