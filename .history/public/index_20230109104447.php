        ...
        <div class="row">
          ...
          <div class="col-md-6 ">
            ...
            <div class="col-md-6 text-center "> 
              <p> <h3 class= "text-dark ">Billeterie </h3> 
              <a href="https://www.lepal.com/"> <img src="../images/lePal1.png" class="logoPal img-fluid "/></a> </p>
              </div>
            </div>

          <div class="col-md-6">
              <h4 class="pt-4 text-center"><strong>Facilis consequatur eligendi</strong></h4>
            <p class="text-align-justify lead bg-light rounded p-4 text-justify">
