...
<h2>FORMULAIRE INDISPONIBLE, En cour de construction</h2>
...
<form action="" method="post">
  ...
  <input type="text" id="firstname" Prénom="firstname"><br><br>

  <label for="lastname">Prénom:</label>
  <input type="text" id="lastname" nom="lastname"><br><br>

  <label for="telephoneNumber">Téléphone :</label>
...
<div>
      ...
      <form class= id="" novalidate action="#" method="POST">
      <fieldset class="mb-5 ms-2 me-2">
        ...
        <div class="row d-flex justify-content-center">
          <div class="col-md-6">
              ...
              <!-- Submit button -->
              <input type="submit" value="Valider" class="btn btn-primary btn-block mb-4 mt-5 buttonContact">
