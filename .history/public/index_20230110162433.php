    ...
    Isabelle et son équipe se tiennent à votre disposition pour faire de votre séjour un moment inoubliable.
      ...
      <div class="container ">
        ...
        <div class="col embed-responsive embed-responsive-16by9 order-1">
          <iframe class="videoPal1 embed-responsive-item"  src="https://www.youtube.com/embed/PWIjFCqQw78" title="YouTube video player"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          </div>
          ...
          <div class="col embed-responsive embed-responsive-16by9 d-none d-lg-block order-3"> 
            <iframe class=" videoPal2 embed-responsive-item"src="https://www.youtube.com/embed/m7PrIAN_Krs" title="YouTube video player"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
...
<h4 class="mb-4 carouseTitle border border-3 rounded bg-light p2">VENEZ DECOUVRIR LA BEAUTE DE LA CAMPAGNE</h4>
...
<section>
      ...
      <section class="mb-5">
        <h4 class="m-5 text-center border border-3 rounded bg-light" bg-light id="contact"><strong>NOUS CONTACTER</strong></h4>
