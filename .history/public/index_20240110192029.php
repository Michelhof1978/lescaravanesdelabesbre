    ...
    <div class="row ">
      ...
      <div class="col-sm-12 col-xl-6 ">
        <p class="textIntro lead bg-light rounded shadow p-4 pb-5 bg-white rounded ms-1 me-1 ">
          Profitez d'une expérience de camping unique au <strong> <a href="<?php echo CAMPING_URL; ?>" target="_blank">Camping proche du Pal de Dompierre Sur Besbre</a>, situé à proximité du parc d'attractions <a href="<?php echo _URL; ?>" target="_blank">Le-Pal</a></strong>.
