...
<footer class="container-fluid">
  <div class="row">
    ...
    <div class="img3 col-12 pt-3">
      ...
      <p class="copyright d-flex flex-wrap text-sm">Site réalisé par <a href="https://cvmichel-hoffmann.fr/" target="_blank"><strong>Michel Hoffmann - Harmony Digital</strong></a></p>


      <div class="mb-2">
        <!-- Facebook -->
        <a class="btn btn-primary btn-floating m-1" style="background-color: #3b5998;" href="https://www.facebook.com/lescaravanesdelabesbre/" target="_blank" role="button">
        ...
        <!-- office du tourisme -->
        <a class="btn btn-primary btn-floating m-1" style="background-color: #55acee;" href="https://tourisme.interco-abl.info/" target="_blank" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-info-circle" viewBox="0 0 16 16">
            <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
            <path d="m8.93 6.588-2.29.287-.082.38.45.083c.294.07.352.176.288.469l-.738 3.468c-.194.897.105 1.319.808 1.319.545 0 1.178-.252 1.465-.598l.088-.416c-.2.176-.492.246-.686.246-.275 0-.375-.193-.304-.533L8.93 6.588zM9 4.5a1 1 0 1 1-2 0 1 1 0 0 1 2 0z" />
          </svg></a>

        <!-- Instagram -->
        <a class="btn btn-primary btn-floating m-1" style="background-color: #dd4b39;" href="https://www.instagram.com/lescaravanesdelabesbre/?hl=fr" target="_blank" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
        ...
        <!-- Météo -->
        <a class="btn btn-primary btn-floating m-1" style="background-color: #ac2bac;" href="https://meteofrance.com/previsions-meteo-france/allier/3" target="_blank" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-brightness-high" viewBox="0 0 16 16">
        ...
        <!-- Linkedin -->
        <a class="btn btn-primary btn-floating m-1" style="background-color: #0082ca;" href="https://www.linkedin.com/in/michel-h-245436203/" target="_blank" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-linkedin" viewBox="0 0 16 16">
...
<div class="text-center p-2" style="background-color: rgba(0, 0, 0, 0.2)">
  ...
  <a class="text-dark d-flex flex-wrap text-sm" href="https://cvmichel-hoffmann.fr/" target="_blank">Harmony Digital-Droits réservés</a>
  </p>
</div>
<!-- FIN Copyright -->
...
<div class="text-center mt-3">
  <a href="https://www.mon-compteur.fr"><img src="https://www.mon-compteur.fr/html_c01genv2-237765-2" alt="nombre de visites"></a>
</div>
