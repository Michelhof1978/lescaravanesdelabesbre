...
<head>
    ...
    <title>Réservation de Logements - Le Pal</title>
</head>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST["message"]) && isset($_POST['g-recaptcha-response'])) {
        ...
        if ($response['success']) {
            ...
            $message = "Réservation de logements au Parc d'Attractions Le Pal :\n" .
                "Nom : " . htmlspecialchars($_POST["firstName"]) . "\n" .
                "Prénom : " . htmlspecialchars($_POST["lastName"]) . "\n" .
                "Téléphone : " . htmlspecialchars($_POST["phoneNumber"]) . "\n" .
                "Email : " . htmlspecialchars($_POST["email"]) . "\n" .
                "Type de logement : " . htmlspecialchars($_POST["typeLogement"]) . "\n" .
            ...
            $retour = mail("postmaster@lescaravanesdelabesbre.fr", "Réservation de logements - Le Pal", $message, "From: contact@lescaravanesdelabesbre.fr" . "\r\n" . "Reply-to: " . htmlspecialchars($_POST["email"]));
...
<h4 class="m-5 text-center border border-3 rounded text-white p-2 display-6 h4Index" id="contact"><strong>RÉSERVATION DE LOGEMENTS</strong></h4>
    ...
    <fieldset class="mb-5 ms-2 me-2">
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-md-6">
                ...
                <div class="form-outline mb-4">
                    <label class="form-label round" for="typeLogement">Type de logement :</label>
                    <select class="form-label" name="typeLogement" id="typeLogement">
                ...
                <div class="form-outline mb-4">
                    <label class="form-label round" for="nombrePersonnes">Nombre de personnes :</label>
                    <input name="nombrePersonnes" type="number" id="nombrePersonnes" class="form-control" placeholder="Nombre de personnes" required>
                    <label for="nombrePersonnes" class="form-label"></label>
                    <div class="invalid-feedback">
...
<!-- Ajoutez vos scripts Google Analytics et autres ici -->
