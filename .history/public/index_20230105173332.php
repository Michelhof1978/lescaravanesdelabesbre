...
<section id="slideshow">
	...
	<div class="container col-6 col-md-4 col-lg-3">
		<div class="c_slider col-6 col-md-4 col-lg-3"></div>
		<div class="slider col-6 col-md-4 col-lg-3">
			<figure>
				<img src="../images/oies.jpg" alt="" width="640" height="310" />
				<figcaption class="col-6 col-md-4 col-lg-3">Ballades au bord des étangs</figcaption>

			</figure><!--
			--><figure class="col-6 col-md-4 col-lg-3">
				<img src="../images/tournesol.jpg" alt="" width="640" height="310" />
				<figcaption cl*col-6 col-md-4 col-lg-3>Champs de tournesols</figcaption>
			</figure><!--
			--><figure class="col-6 col-md-4 col-lg-3">
				<img src="../images/poule.jpg" alt="" width="640" height="310" />
				<figcaption class="col-6 col-md-4 col-lg-3">Fermes Pédagogiques</figcaption>

			</figure><!--
			--><figure col-6 col-md-4 col-lg-3>
				<img src="../images/nature.jpg" alt="" width="640" height="310" />
				<figcaption class="col-6 col-md-4 col-lg-3">Se promener dans la nature</figcaption>
			</figure>
		</div>
	</div>
