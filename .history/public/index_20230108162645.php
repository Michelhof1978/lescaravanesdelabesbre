  ...
  <main class="mt-3">
    <div class="container">
      ...
      <div class=" col-xs-2 col-sm-8 col-md-4 col-lg-4 embed-responsive embed-responsive-16by9"><iframe class="videoPal1 embed-responsive-item" width="450" height="300" src="https://www.youtube.com/embed/PWIjFCqQw78" title="YouTube video player"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
        ...
        <div class="col-xs-3 col-sm-4 col-md-4 col-md-4text-center logoBilletGroup"> <h3 class="billeterie text-dark ">Billeterie <a href="https://www.lepal.com/"> <img src="../images/lePal.png" class="achatBillet img-fluid " /></h3> </a> </div>
