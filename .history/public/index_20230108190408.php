...
<section>
  ...
  <main class="mt-3">
    <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 gx-5  pe-5 ">
            ...
            <div class="bg-image  ripple shadow-2-strong rounded-5 " data-mdb-ripple-color="light">
              ...
              <img src="../images/banner3.png" class="img-fluid h-350 w-250 bg-image h" />
          ...
          <div class="col-md-6 gx-5 mb-4 ">
            ...
            <p class="text-muted lead bg-light rounded p-4">
      ...
      <div class="col-xs-4 embed-responsive embed-responsive-16by9">
        ...
        <div class="col6-xs-4 text-center logoBilletGroup"> 
          <h3 class= "text-dark ">Billeterie 
            <a href="https://www.lepal.com/"> 
            <img src="../images/lePal.png" class="logoPal img-fluid " />
          </h3> 
          </a> 
        </div>
