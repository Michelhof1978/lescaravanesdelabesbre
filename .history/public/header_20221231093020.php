...
<nav class="navbar navbar-expand-md bg-body-tertiary">
  ...
  <div class="col-3"><a class="navbar-brand  fs-2 pb-4  " href="#">Les Caravanes De La Besbre <span class="orange">.</span></a></div>

    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
      <span class="navbar-toggler-icon"></span>
    </button>
    <div class="collapse navbar-collapse justify-content-end custom-line sticky-bottom col-6" id="navbarNav">
