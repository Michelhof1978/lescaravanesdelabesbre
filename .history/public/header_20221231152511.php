...
<div class="container-fluid">
  ...
  <div class="navbar-brand fs-2 ps-3  col-5" href="#">Les Caravanes De La Besbre <span class="orange">.</span></div>
  ...
  <!-- Création hamburger en responsive -->
    ...
    <div class="collapse navbar-collapse" id="navbarNav"><!-- id appel la fonction hamburger de boostrap aria-controls -->
...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  ...
  <div class=" p-0"><img src="../images/logo.png" alt="Logo" width="150" height="130" ></div>
  <div class="navbar-brand fs-3 ps-3  " href="#">Les Caravanes De La Besbre <span class="orange">.</span></div>
