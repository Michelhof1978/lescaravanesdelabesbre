  ...
  <div class="row align-items-center justify-content-center h-100">
    ...
    <div class="col-md-8 col-lg-6 p-3">
      <div class="bg-light shadow p-5">
        ...
        Nous avons passé un excellent séjour chez cet hôte. L'appartement était propre, confortable. L'hôte était également très accueillant et a répondu rapidement à toutes nos questions. Nous recommandons vivement cet endroit à tous ceux qui cherchent un endroit confortable et bien situé pour séjourner.
        </div>
