...
<script>
    ...
    function validateForm() {
        ...
        // Vérification si la valeur du numéro de téléphone est un nombre
        ...
        // Expression régulière pour valider le numéro de téléphone (maximum 15 chiffres)
        var phoneRegex = /^[0-9]{1,15}$/;

        if (!phoneRegex.test(phoneNumberValue)) {
            alert('Veuillez saisir un numéro de téléphone valide (maximum 15 chiffres).');
            phoneNumberInput.focus();
            return false;
        }
