...
if (isset($_POST["message"])) {
    ...
    $secret_key = '6LcJ6VEnAAAAAAsXdPAoyQk4uf7J-Y18F7B8R3bj'; // Remplacez par votre clé secrète reCAPTCHA
    ...
    if ($json->success) {
        ...
        if ($retour) {
            ...
            echo '<script>window.location.replace("confirmationContactRenseignements.php");</script>';//Obligation de mettre un script au lieu du php car en php, ça ne renvoi pas sur la page de confirmation
            exit();
        } else {
...
<div class="g-recaptcha mt-3" data-sitekey="6LcJ6VEnAAAAAAsXdPAoyQk4uf7J-Y18F7B8R3bj"></div>
