...
<header class=" p-0 img-fluid bg-image justify-content-center align-items-center" style="background-image:url(../images/banner3.png); background-size:cover; background-position:center; height: 500px;height: 1000vh">
