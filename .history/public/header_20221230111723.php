...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  ...
  <div class="">  <img src="../images/logo.png" alt="Logo" width="150" height="130" class="d-inline-block align-text-top"></div>
    <div>><a class="navbar-brand fs-2 pb-4" href="#">Les Caravanes De La Besbre <span class="orange">.</span></a></div

    <button class="navbar-toggler"></button></button> type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
