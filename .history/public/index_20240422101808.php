...
<script>
  ...
  function setPopupShown() {
    ...
    expirationDate.setFullYear(expirationDate.getFullYear() + 5); // Expiration dans 5 ans
  ...
  if (!isPopupShown()) {
    ...
    img.src = "../images/lePal2024.png"; // Chemin relatif vers l'image
    img.style.height = window.innerWidth < 600 ? '80%' : '60%'; // Adaptation à la taille de l'écran
    img.style.width = img.style.height;

    popupDiv.appendChild(img);

    // Création et configuration du bouton de fermeture
    ...
    // Fermeture automatique du popup après 30 secondes
    setTimeout(function() {
