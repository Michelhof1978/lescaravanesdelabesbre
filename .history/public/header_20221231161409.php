...
<nav class="navbar navbar-expand-lg bg-body-tertiary p-0zz">
...
<div class="container-fluid g-0">
   ...
   <div class="row ">
    ...
    <div class="col-3  p-0 g-0"><img src="../images/logo.png" alt="Logo" width="150" height="130" ></div>
  <div class=" col-4 navbar-brand  p-5 g-0" href="#">Les Caravanes De La Besbre <span class="orange">.</span></div>
  ...
  <!-- Création hamburger en responsive -->
    ...
    <button class="navbar-toggler col-12 text-right g-0" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
