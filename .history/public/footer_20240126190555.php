...
<script>
    window.addEventListener("load", function(){
        window.cookieconsent.initialise({
            ...
            "elements": {
                "allow": '<button style="cursor:pointer;" onclick="acceptCookies()">Accepter</button>',
                "dismiss": '<button style="cursor:pointer;" onclick="rejectCookies()">Refuser</button>'
            }
        });
    });

    function acceptCookies() {
        window.cookieconsent.allow();
    }

    function rejectCookies() {
        window.cookieconsent.dismiss();
    }
</script>
