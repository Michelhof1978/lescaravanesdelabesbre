<?php include("header.php") ?>
    ...
    Isabelle et son équipe se tiennent à votre disposition pour faire de votre séjour un moment inoubliable.
      ...
      <div class="container">
        ...
        <div class=" col">
        <div class="videoPal videoPal1  embed-responsive embed-responsive-16by9">
            <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/PWIjFCqQw78" frameborder="0" allowfullscreen></iframe>
        </div>
        </div>
        ...
        <div class="videoPal embed-responsive embed-responsive-16by9 video">
