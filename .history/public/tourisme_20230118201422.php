...
<!--SlideShow-->
<h1 class="pb-2 text-center  border border-3 rounded bg-light m-4">Loin de tout, proche de l'étientiel</h1>

<div class="text-center m-5 slideShow">
    <video width="520" height="380" controls><source src="../videos/besbre.mp4" type=video/mp4></video>
</div>
<!--EndSlideShow-->
