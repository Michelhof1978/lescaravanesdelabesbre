...
<div class="container-fluid ">
   ...
   <div class="row">
    ...
    <div class="col-lg-3 col-xl-2"><img src="../images/logo.png" alt="Logo" width="150" height="130" ></div>
  <div class=" col-lg-3 col-xl-5 navbar-brand fs-2" href="#">Les Caravanes De La Besbre <span class="orange">.</span></div>
