...
<div class="container mt-5 mb-5">
    <div class="row">
        ...
        <div class="col-lg-6">
            ...
            <div class="ms-lg-5">
                <img src="../images/festi03.webp" alt="concert festiDomp" class="videoPal embed-responsive embed-responsive-16by9 ms-5 img-fluid text-center w-75" />
                <img src="../images/festi02.webp" alt="concert festiDomp" class="videoPal embed-responsive embed-responsive-16by9 ms-5 img-fluid text-center w-75" />
            </div>
        </div>
    </div>
</div>
