    ...
    <div class="row">
      ...
      <div class=" col-lg-6 mb-3">
        <div class="text-center">
          ...
          <img src="../images/festi01.webp" alt="image concert festiDomp" loading="lazy" class="videoPal embed-responsive embed-responsive-16by9 img-fluid mb-5 text-center w-75">
        </div>
        <div class="videoPal embed-responsive embed-responsive-4by3">
    <video controls class="embed-responsive-item videoPal1" src="../videos/festi01.mp4" alt="Concert Festi Domp"></video>
...
<div class="videoPal embed-responsive embed-responsive-4by3 mt-5">
    <video controls class="embed-responsive-item videoPal1" src="../videos/festi04.mp4" alt="Concert Festi Domp"></video>
    <figcaption class="text-center">Concert Festi Domp 2ème Partie</figcaption>
      ...
      <div class="col-lg-6">
        <div class="">
          <img src="../images/laMontagne.webp" loading="lazy" alt="logo journal la montagne" class="img-fluid mb-lg-5">
        </div>
        ...
        <div class="ms-lg-5">
          <img src="../images/festi03.webp" loading="lazy" alt="concert festiDomp" class="videoPal embed-responsive embed-responsive-16by9 ms-5 img-fluid mb-5 text-center w-75">
          <img src="../images/festi02.webp" loading="lazy" alt="concert festiDomp" class="videoPal embed-responsive embed-responsive-16by9 ms-5 img-fluid mb-5 text-center w-75">
        </div>
