...
<a href="<?php echo AIRBNB1_URL; ?>" target="_blank" class="btn btn-primary">Réservez Sur Airbnb (Tarifs Majorés de 20%) !</a>
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p><strong>OU</strong></p>
            <a href="<?php echo AIRBNB2_URL; ?>https://www.airbnb.fr/rooms/34376099?check_in=2023-07-07&check_out=2023-07-09&guests=1&adults=2&s=13&unique_share_id=0e8b24e2-1835-49a1-a4a3-18082f186b0a&source_impression_id=p3_1673810303_FnHo0G0d1awJpqSg" target="_blank" class="btn btn-primary">Réservez Sur Airbnb (Tarifs Majorés de 20%) !</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="card">
          <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
            <img src="../images/caravane3.webp" alt="hôtel le pal" loading="lazy" class="img-fluid">
            <a href="#!">
          ...
          <div class="card-body">
            ...
            <a href="resaContact.php" class="btn btn-primary">Réservez Directement Sur Le Site !</a> <br><br>
            <p><strong>OU</strong></p>
            <a href="<?php echo AIRBNB3_URL; ?>https://www.airbnb.fr/rooms/33922569?guests=1&adults=1&s=13&unique_share_id=dedc2c3e-e938-44ad-9f3d-ce705e5c250f&source_impression_id=p3_1673797473_hQe7qv%2BRa82qaxPN" target="_blank" class="btn btn-primary">Réservez Sur Airbnb (Tarifs Majorés de 20%) !</a>
...
<h4 class="m-5 text-center border border-3 rounded text-white p-2 display-6 h4Index"><strong>INFOS LES CARAVANES DE LA BESBRE</strong></h4>
    <div class="container-fluid mt-5">
      ...
      <div class="col-xl-4 col-md-4 mt-3 mb-5">
        <a href="https://m.facebook.com/festi.domp.3"><img src="../images/festiDomp.webp" alt="logo fest domp" loading="lazy" class="img-fluid w-100"></a>
      </div>
  ...
  <div class="container ">
    ...
    <div class="row ">
      ...
      <div class="col-sm-12 col-xl-6 ">
        <img src="../images/bannerIntro.webp" alt="Le Pal" loading="lazy" class="img-fluid">
      </div>

      <div class="col-sm-12 col-xl-6 ">
        <p class="textIntro lead bg-light rounded shadow p-4 pb-5 bg-white rounded ms-1 me-1 ">
          Profitez d'une expérience de camping unique au <strong> <a href="<?php echo CAMPING_URL; ?>">Camping proche du Pal de Dompierre Sur Besbre</a>, situé à proximité du parc d'attractions <a href="https://www.lepal.com/">Le-Pal</a></strong>.
  ...
  <div id="carouselExampleCaptions" class="carousel slide carousel carouselIndex ">
    ...
    <div class="carousel-inner ">
      <div class="carousel-item active ">
        <img src=" ../images/oies.webp" class="d-block w-100" alt="Tourisme En Auvergne" loading="lazy">
      ...
      <div class="carousel-item">
        <img src="../images/tournesol.webp" class="d-block w-100 " alt="Champs De Tournesol" loading="lazy">
        <div class="carousel-caption d-none d-md-block">
      ...
      <div class="carousel-item">
        <img src=" ../images/poule.webp" class="d-block w-100 " alt="Poules et Poussins" loading="lazy">
        <div class="carousel-caption d-none d-md-block">
