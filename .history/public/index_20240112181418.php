...
<script>
  ...
  let nouveau = document.querySelector('#nouveau');//Sélectionne l'élément HTML avec l'id "avi" (Endroit où va être afficher l'avis) et le stocke dans la variable avi.
  let avi = document.querySelector('#avi');
//Sélectionne l'élément HTML avec l'id "auteur" (probablement un élément où afficher l'auteur de l'avis) et le stocke dans la variable auteur.
