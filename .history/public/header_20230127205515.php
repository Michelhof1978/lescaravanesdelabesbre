...
<div class=" row  d-flex align-items-start">
    ...
    <div class=" col-4 navbar-brand pt-0 ps-4 fs-1 ms-2" href="#">Les Caravanes De La Besbre <span class="orange">.</span></div>
</div>
...
<ul class="navbar-nav fs-5 px-5">
  ...
  <li class="nav-item">
    <a class="nav-link fs-3" aria-current="page" href="index.php">Accueil</a>
  </li>
  <li class="nav-item">
    <a class="nav-link fs-3" href="informations.php">Informations</a>
  </li>
  <li class="nav-item">
    <a class="nav-link fs-3" href="tourisme.php">Tourisme</a>
  </li>
  <li class="nav-item">
    <a class="nav-link fs-3" href="https://www.lepal.com/">Vente Billets</a>
  </li>
  <li class="nav-item">
    <a class="nav-link fs-3" #contact  href="#contact">Contact</a>
  </li>
