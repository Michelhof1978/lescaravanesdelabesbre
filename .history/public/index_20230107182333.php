...
<section>
  ...
  <main class="mt-3">
    <div class="container">
      ...
      <section class="embed-responsive embed-responsive-21by9 d-flex">

      
<iframe class="embed-responsive-item align-items-center order-first videoPal1 "width="490" height="300" src="https://www.youtube.com/embed/PWIjFCqQw78" title="YouTube video player"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
  <div>  <h3 class="achatBillet"> <a class="text-dark order-first order-md-2 order-lg-3" href="https://www.lepal.com/">Billeterie</a></h3> 
   <img class="order-first" src="../images/lePal.png" class="img-fluid w-20 class="order-md-3 order-lg-2" />
    <iframe class="embed-responsive-item align-items-center order-md-3 order-lg-2 videoPal2" "width="490" height="300" src="https://www.youtube.com/embed/m7PrIAN_Krs" title="YouTube video player"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</section>
