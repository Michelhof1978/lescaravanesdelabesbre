    ...
    <div class="col-lg-4 col-md-6 mb-4">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <a href="resaContact.php" class="btn btn-primary">Réservez Directement Sur Le Site !</a> <br> <p>OU</p>
    ...
    <div class="col-lg-4 col-md-6 mb-4">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <a href="resaContact.php" class="btn btn-primary">Réservez Directement Sur Le Site !</a>  <p>OU</p> <br>
