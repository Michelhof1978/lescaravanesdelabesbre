...
<div>  
      <div class="text-center logoConfirmationForm ">
        <img src="./images/logo.png" alt="Le Pal" class="img-fluid " />
      </div>

      <div class="">
        <p class=" lead text-success text-center display-4">
...
<h4 class="m-5 text-center border border-3 rounded text-white p-2 display-6 h4Index" id="contact"><strong>MERCI</strong></h4>
      ...
      <div class="lead text-success display-4 text-center">
        Nous vous remercions sincèrement d'avoir choisi Les Caravanes De La Besbre pour votre prochaine réservation.<br>
         Nous avons bien reçu votre formulaire de contact et nous vous confirmons que votre demande est en cours de traitement.
      </div>
