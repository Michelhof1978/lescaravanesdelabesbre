...
<div class="container mt-5">
  <div class="row">
    <div class="col-md-5 text-center mb-4 mx-auto"> <!-- Ajout de la classe mx-auto pour centrer le contenu -->
      <a href="https://m.facebook.com/festi.domp.3">
        <img src="../images/festiDomp.webp" alt="logo fest domp" class="img-fluid w-75" />
      </a>

      <img src="../images/festi01.webp" alt="concert festiDomp" class="videoPal embed-responsive embed-responsive-16by9 ms-md-5 img-fluid mb-4 img-thumbnail mx-auto" /> <!-- Ajout de la classe mx-auto pour centrer l'image -->
    ...
    <div class="col-md-7 text-center align-self-center mx-auto"> <!-- Ajout de la classe mx-auto pour centrer le contenu -->
      <img src="../images/laMontagne.webp" alt="logo journal la montagne" class="img-fluid mb-4 img-thumbnail mx-auto" /> <!-- Ajout de la classe mx-auto pour centrer l'image -->
      <div class="lead mt-5 bg-light rounded shadow p-4 pb-5 bg-white rounded ms-md-1 me-md-1 mb-4">
        <p class="pageSouvenir">
      ...
      <img src="../images/festi03.webp" alt="concert festiDomp" class="videoPal embed-responsive embed-responsive-16by9 ms-md-5 img-fluid mb-4 img-thumbnail mx-auto" /> <!-- Ajout de la classe mx-auto pour centrer l'image -->
      <img src="../images/festi02.webp" alt="concert festiDomp" class="videoPal embed-responsive embed-responsive-16by9 ms-md-5 img-fluid mb-4 img-thumbnail mx-auto" /> <!-- Ajout de la classe mx-auto pour centrer l'image -->
    </div>
  </div>
</div>
