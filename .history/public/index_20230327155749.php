...
// Sélectionnez l'image et son conteneur parent
imgDiv = document.querySelector('img');
const parent = imgDiv.parentNode;

// Fonction pour mettre à jour la largeur de l'image
function setImgWidth() {
  const parentWidth = parent.offsetWidth;
  imgDiv.style.width = `${parentWidth}px`;
}

// Appel initial de la fonction pour définir la largeur de l'image
setImgWidth();

// Ajout d'un écouteur d'événements pour redimensionner la fenêtre
