  ...
  <div class="row">
    ...
    <div class="img3 col-12 pt-3">
      ...
      <div class="mb-2">
        ...
        <!-- office du tourisme -->
        <a class="btn btn-primary btn-floating m-1" style="background-color: #55acee;" href="TOURISM_URL" target="_blank" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-info-circle" viewBox="0 0 16 16">
