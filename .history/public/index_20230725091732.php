    ...
    <div class="col-lg-4 col-md-6 mb-4">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <a href="resaContact.php" class="btn btn-primary">Réservez Directement Sur Le Site !</a>  <br><br> <p><strong>OU</strong></p>
...
<div>
<div>
<img src="../images/articleLaMontagne.webp" alt="Article journal"  class="text-center img-fluid videoPal w-50" /> 
</div>

<div>
<img src="../images/laMontagne.webp" alt="logo journal la montagne"  class="text-center img-fluid videoPal w-50" /> 
