...
<section>
  ...
  <main class="mt-3">
    <div class="container">
      ...
      <div class="row">
      <section class="embed-responsive embed-responsive-21by9r justify-content-center row">
<div><iframe class="embed-responsive-item align-items-center videoPal1 col" width="450" height="300" src="https://www.youtube.com/embed/PWIjFCqQw78" title="YouTube video player"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
  <div class=""> <h3 class="achatBillet text-dark  col" href="https://www.lepal.com/">Billeterie <br> <img src="../images/lePal.png" class="img-fluid w-25" /></h3> </div>
   
  <div> <iframe class="embed-responsive-item align-items-center videoPal2 col" width="450" height="300" src="https://www.youtube.com/embed/m7PrIAN_Krs" title="YouTube video player"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
</section>
</div>
</div>
      <!--Section: Content-->
