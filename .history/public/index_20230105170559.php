...
<!--Carousel-->
      <div class="clear">VENEZ DECOUVRIR LA BEAUTE DE LA CAMPAGNE</div>
<section class="clear img-fluid">
...
?>
      ...
      <section class="mb-5">
        <h4 class="mb-5 pt-6 text-center git push --set-upstream origin" id="contact"><strong>NOUS CONTACTER</strong></h4>
