...
<section class="text-center mt-4 m-2">
  ...
  <div class=" col text-center d-none d-md-block align-self-center">
        <h2 class="text-dark display-6 mb-5">Nouvelle Attraction 2024 </h2>
        <img src="../images/attraction2024.jpg" alt="Nouvelle attraction le pal 2024" loading="lazy" class="img-fluid w-50 border-2 mb-5">
      </div>
