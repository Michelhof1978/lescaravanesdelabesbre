...
<section class="offre">
    ...
    <div class="">
      <section class="embed-responsive embed-responsive-21by9r ">
<div><iframe class=" loat-embed-responsive-item videoPal1 float-start" width="450" height="300" src="https://www.youtube.com/embed/PWIjFCqQw78" title="YouTube video player"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
  <div class="float-center"> <h3 class="achatBillet text-dark " href="https://www.lepal.com/">Billeterie <br> <img src="../images/lePal.png" class="img-fluid w-25" /></h3> </div>
   
  <div> <iframe class="text-md-end align-items-end embed-responsive-item align-items-center videoPal2 float-right" width="450" height="300" src="https://www.youtube.com/embed/m7PrIAN_Krs" title="YouTube video player"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
</section>
</div>
