...
<div id="mainNavigation">
  ...
  <nav role="navigation" >
    ...
    <div class="pt-2 text-center border-bottom container">
      <div class="row">
     <div class="col-4"><img id="logo" src="../images/logo.webp" alt="Logo Les caravanes De La Besbre" style="height:160px " class="img-fluid logo "></div> 

      <div class=" navbar-brand fs-2 textLogo col-4" href="#">Les Caravanes De La Besbre <span class="orange">.</span></div> 
      
      <div class=""><img src="../images/papillons.gif" alt="Papillons" style="height:100px " class="img-fluid"></div>
    </div>
    </div>
