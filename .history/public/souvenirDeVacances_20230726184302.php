...
<div class=" mt-5 text-center bg-light rounded shadow p-4 pb-5 bg-white rounded ms-1 me-1 mb-5">
        <p class=" pageSouvenir lead">
        Vous avez des souvenirs de vacances à partager ? Des vidéos, des images ou un petit message que vous souhaitez
...
<a href="https://m.facebook.com/festi.domp.3"><img src="../images/festiDomp.webp" alt="logo fest domp" class="img-fluid w-75 text-center" /></a>

<img src="../images/festi01.webp" alt="concert festiDomp"  class="videoPal embed-responsive embed-responsive-16by9 ms-5 img-fluid mb-5 text-center w-50" /> 
...
<!--VIDEO CONTROLS PERMET A LA VIDEO DE NE PAS SE LANCER AUTOMATIQUEMENT -->
...
----------------------------------------------------------------------------------------------------------$_COOKIE<?php include("header.php") ?>
...
<div class="container mt-5">
  <div class="row">
    <div class="col-md-5 text-center mb-4">
      <a href="https://m.facebook.com/festi.domp.3">
        <img src="../images/festiDomp.webp" alt="logo fest domp" class="img-fluid w-75" />
      </a>

      <img src="../images/festi01.webp" alt="concert festiDomp" class="videoPal embed-responsive embed-responsive-16by9 ms-md-5 img-fluid mb-4 img-thumbnail" />

      <div class="videoPal embed-responsive embed-responsive-16by9 ms-md-5 mb-4">
        <video controls class="embed-responsive-item videoPal1" src="../videos/festi01.mp4" frameborder="0" allowfullscreen></video>
      </div>

      <div class="videoPal embed-responsive embed-responsive-16by9 ms-md-5">
        <video controls class="embed-responsive-item videoPal1" src="../videos/festi04.mp4" frameborder="0" allowfullscreen></video>
      </div>
      <!--VIDEO CONTROLS PERMET À LA VIDÉO DE NE PAS SE LANCER AUTOMATIQUEMENT -->

    </div>

    <div class="col-md-7 text-center align-self-center"> <!-- Ajout de la classe align-self-center pour centrer le texte -->
      <img src="../images/laMontagne.webp" alt="logo journal la montagne" class="img-fluid mb-4 img-thumbnail" />
      <div class="lead mt-5 bg-light rounded shadow p-4 pb-5 bg-white rounded ms-md-1 me-md-1 mb-4">
        <p class="pageSouvenir text-center"> <!-- Ajout de la classe text-center pour centrer le texte -->
          Vous avez des souvenirs de vacances à partager ? Des vidéos, des images ou un petit message que vous souhaitez
          faire passer ? Nous serions ravis de les recevoir ! Vos contributions permettront à nos utilisateurs d'être
          guidés dans leurs futures escapades et de découvrir quelques balades secrètes à faire. N'oubliez pas :
          profitez de la vie à fond et partagez ces moments magiques avec la communauté ! Ensemble, créons des
      ...
      <img src="../images/festi03.webp" alt="concert festiDomp" class="videoPal embed-responsive embed-responsive-16by9 ms-md-5 img-fluid mb-4 img-thumbnail" />
      <img src="../images/festi02.webp" alt="concert festiDomp" class="videoPal embed-responsive embed-responsive-16by9 ms-md-5 img-fluid mb-4 img-thumbnail" />
    </div>
  </div>
</div>
