        ...
        <div class="col-lg-4 col-md-12 mb-4">
            <div class="card">
                <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                    <img src="../images/caravane1.webp" alt="Caravane BIG - Hébergement pour 4 personnes" class="img-fluid">
                    <a href="#">
    ...
    <div class="row ">
      ...
      <div class="col-sm-12 col-xl-6 ">
        <p class="textIntro lead bg-light rounded shadow p-4 pb-5 bg-white rounded ms-1 me-1 ">
          ...
          Vous serez enchanté par l'ambiance caravane proposée par notre équipe. Des caravanes tout confort et entièrement équipées sont disponibles du <strong>01/07/2024 au 01/08/2023</strong> pour accueillir 4 personnes chacune (2 adultes et 2 enfants).
