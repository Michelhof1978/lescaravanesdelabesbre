...
<form class="needs-validation" id="formulaire" novalidate action="#" method="POST">
  ...
  // Créer les champs de date de naissance
  var dateNaissance1 = document.createElement("input");
  dateNaissance1.type = "date";
  dateNaissance1.name = "dateNaissance1";
  dateNaissance1.placeholder = "Date de naissance 1";

  var dateNaissance2 = document.createElement("input");
  dateNaissance2.type = "date";
  dateNaissance2.name = "dateNaissance2";
  dateNaissance2.placeholder = "Date de naissance 2";

  // Ajouter les champs au formulaire
  document.getElementById("formulaire").appendChild(dateNaissance1);
  document.getElementById("formulaire").appendChild(dateNaissance2);
}
    </script>
