...
<section class="index text-center clear mt-4 ms-2 me-2">
  ...
  <div class="row locationIndex">
    ...
    <p class="card-text text-sm"> <!-- Ajout de la classe text-sm pour un texte plus petit en mode mobile -->
        ...
        <br><p></p>Option d'hébergement sous le auvent, permettant d'accueillir 2 personnes supplémentaires pour <strong>12,00 €</strong> par personne (matelas non fournis, veuillez prévoir).
    </p>
