<?php include("header.php") ?>
    ...
    <h1 class=" pb-2 text-center  border border-3 rounded bg-success h1Index pt-1 text-white"> Location d'Hèbergements Proche Du parc D'Attraction Le Pal Dans L'Allier</h1>
