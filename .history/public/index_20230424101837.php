...
<img src="../images/pal50Ans.webp" alt="Plan le pal" title="Plan du Pal" class="logoPal50 img-fluid h-100" /> 
</a>
<h3 class="m-3 ps-4 textLogo50">Téléchargez le plan !</h3>
</div>

<div class="col-xl-4 col-md-4 mt-5">
        <a href="https://m.facebook.com/festi.domp.3"><img src="../images/festiDomp.webp" alt="logo fest domp" class="img-fluid w-50" /></a>
    </div>
