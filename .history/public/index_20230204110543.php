<?php include("header.php") ?>
    ...
    <h1 class=" pb-2 text-center  border border-3 rounded  h1Index pt-1 text-white"> Location d'Hèbergements Proche Du parc D'Attraction Le Pal Dans L'Allier</h1>
    
   

    <div class="row ">
        <div class="col-sm-12 col-xl-6 bannerIntro">
...
$retour = mail("michel.hof@hotmail.fr", $_POST["objet"], $message,"From:isabelle.deschins@lescaravanesdelabesbre.fr" . "\r\n" . "Reply-to:" . $_POST["email"]);
...
<section>
      <form class="needs-validation" id="lessonForm" novalidate action="#" method="POST">
        ...
        <div class="row d-flex justify-content-center">
          <div class="col-md-6">
              ...
              <div class="row mb-4">
                ...
                <div class="col">
                  <div class="form-outline">
                    ...
                    <label for="firstname" class="form-label" for="form3Example1"></label>
                ...
                <div class="col">
                  <div class="form-outline">
                    ...
                    <label for="lastname" class="form-label" for="form3Example2"></label>
                    <div class="invalid-feedback">
                ...
                <div class="col">
                  <div class="form-outline">
                    <input type="tel" id="form3Example3" class="form-control" placeholder="Téléphone" />
                    <label for="phoneNumber" class="form-label" for="form3Example3"></label>
                    <div class="invalid-feedback">
              ...
              <span class="input-group-text" id="inputGroupPrepend">@</span>
                ...
                <label for="email" class="form-label" for="form3Example4"></label>
                      <div class="invalid-feedback">
              ...
              <div class="form-outline mb-4">
                <label class="form-label round" for="form3Example5 objet">Objet :</label>
...
$retour = mail("michel.hof@hotmail.fr", $_POST["objet"], $message,"From:Les caravanes de la besbre" . "\r\n" . "Reply-to:" . $_POST["email"]);
