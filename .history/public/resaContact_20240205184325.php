...
<form class="needs-validation" id="myForm" onsubmit="return validateForm()" novalidate action="#" method="POST">
    ...
    <input name="nombreEnfants" type="number" id="nombreEnfants" class="form-control" placeholder="Indiquez le nombre d'enfants" required onchange="ajouterChampsDateNaissance( containerDatesNaissance)" min="0">
    <div class="invalid-feedback">
...
<script>
    ...
    // Appeler la fonction lors du chargement complet du document
