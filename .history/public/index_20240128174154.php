...
<section class="text-center mt-4 m-2">
  ...
  <div class=" col text-center d-none d-md-block align-self-center">
        <h2 class="text-dark display-6 mb-4">Nouvelle Attraction 2024 </h2>
        <img src="../images/attraction2024.jpg" alt="Nouvelle attraction le pal 2024" loading="lazy" class="img-fluid w-50 rounded-2  mb-5">
      </div>
  ...
  <div class="container">
    <div class="row g-0">
      ...
      <div class="col d-none d-xl-block">
        <div class="videoPal embed-responsive embed-responsive-16by9">
          <iframe width="560" height="315" src="<?php echo YOUTUBE2_URL; ?>" allowfullscreen></iframe>
