...
<section id="slideshow">
	...
	<div class="container d-block w-100">
		...
		<div class="slider ">
			...
			<figure class="col-xs-3 d-block w-50">
				<img class="d-block w-100" src="../images/oies.jpg" alt="" width="640" height="310" />
				<figcaption class="justify-content-center">Ballades au bord des étangs</figcaption>
        </figure><!--

			--><figure class="col-xs-3 d-block w-5">
				<img class="d-block w-100" src="../images/tournesol.jpg" alt="" width="640" height="310" />
				<figcaption class="justify-content-center" >Champs de tournesols</figcaption>
			</figure><!--

			--><figure class="col-xs-3 d-block w-100">
				<img class="d-block w-100" src="../images/poule.jpg" alt="" width="640" height="310" />
				<figcaption class="justify-content-center">Fermes Pédagogiques</figcaption>
        </figure><!--

			--><figure class="col col-xs-3 d-block w-100">
				<img class="d-block w-100" src="../images/nature.jpg" alt="" width="640" height="310" />
