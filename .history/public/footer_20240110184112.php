...
<footer class="container-fluid">
  <div class="row">
    ...
    <div class="img3 col-12 pt-3">
      ...
      <p class="copyright d-flex flex-wrap text-sm justify-content-center">Site réalisé par &nbsp;  <a href="AUTHOR_URL" target="_blank"><strong>Michel Hoffmann - Harmony Digital</strong></a></p>
      ...
      <div class="mb-2">
        ...
        <!-- office du tourisme -->
        <a class="btn btn-primary btn-floating m-1" style="background-color: #55acee;" href="<?php echo FACEBOOK_URL; ?>TOURISM_URL" target="_blank" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-info-circle" viewBox="0 0 16 16">
            <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
            <path d="m8.93 6.588-2.29.287-.082.38.45.083c.294.07.352.176.288.469l-.738 3.468c-.194.897.105 1.319.808 1.319.545 0 1.178-.252 1.465-.598l.088-.416c-.2.176-.492.246-.686.246-.275 0-.375-.193-.304-.533L8.93 6.588zM9 4.5a1 1 0 1 1-2 0 1 1 0 0 1 2 0z" />
          </svg></a>

        <!-- Instagram -->
        <a class="btn btn-primary btn-floating m-1" style="background-color: #dd4b39;" href="<?php echo FACEBOOK_URL; ?>INSTAGRAM_URL" target="_blank" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
        ...
        <!-- Météo -->
        <a class="btn btn-primary btn-floating m-1" style="background-color: #ac2bac;" href="<?php echo FACEBOOK_URL; ?>METEO_URL" target="_blank" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-brightness-high" viewBox="0 0 16 16">
        ...
        <!-- Linkedin -->
        <a class="btn btn-primary btn-floating m-1" style="background-color: #0082ca;" href="<?php echo FACEBOOK_URL; ?>LINKEDIN_URL" target="_blank" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-linkedin" viewBox="0 0 16 16">
            <path d="M0 1.146C0 .513.526 0 1.175 0h13.65C15.474 0 16 .513 16 1.146v13.708c0 .633-.526 1.146-1.175 1.146H1.175C.526 16 0 15.487 0 14.854V1.146zm4.943 12.248V6.169H2.542v7.225h2.401zm-1.2-8.212c.837 0 1.358-.554 1.358-1.248-.015-.709-.52-1.248-1.342-1.248-.822 0-1.359.54-1.359 1.248 0 .694.521 1.248 1.327 1.248h.016zm4.908 8.212V9.359c0-.216.016-.432.08-.586.173-.431.568-.878 1.232-.878.869 0 1.216.662 1.216 1.634v3.865h2.401V9.25c0-2.22-1.184-3.252-2.764-3.252-1.274 0-1.845.7-2.165 1.193v.025h-.016a5.54 5.54 0 0 1 .016-.025V6.169h-2.4c.03.678 0 7.225 0 7.225h2.4z" />
          </svg>

          </a>
        <!-- Github -->
        <a class="btn btn-primary btn-floating m-1" style="background-color: #333333;" href="<?php echo FACEBOOK_URL; ?>GITHUB_URL" target="_blank" role="button">
  ...
  <strong>Les Caravanes De La Besbre - <a href="<?php echo FACEBOOK_URL; ?>CAMPING_URL" target="_blank">Camping "Les Bords De Besbre"</a> - 03 290 Dompierre Sur Besbre</strong>
</p>
...
<div class="text-center p-2" style="background-color: rgba(0, 0, 0, 0.2)">
  ...
  <a class="text-dark" href="<?php echo FACEBOOK_URL; ?>https://cvmichel-hoffmann.fr/" target="_blank">Harmony Digital-Droits réservés</a>
  </p>
</div>
<!-- FIN Copyright -->
