        ...
        <div class="row d-flex justify-content-center">
            <div class="col-md-6">
                ...
                <div class="form-outline mb-4">
                    ...
                    <input type="number" id="nombreEnfants" class="form-control" placeholder="Nombre d'enfants" required>
...
<script>
  document.getElementById('nombreEnfants').addEventListener('change', ajouterChampsDateNaissance);
</script>
...
<script>
  ...
  function ajouterChampsDateNaissance() {
    ...
    // Supprime les champs de date de naissance
    const champsDateDeNaissance = containerDatesNaissance.querySelectorAll('[name^="dateNaissanceEnfant"]');
    for (const champDateDeNaissance of champsDateDeNaissance) {
      containerDatesNaissance.removeChild(champDateDeNaissance);
    }
