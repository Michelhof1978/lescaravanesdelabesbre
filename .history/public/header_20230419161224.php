...
<div id="mainNavigation">
  ...
  <div class="col">   <img id="logo" src="../images/logo.webp" alt="Logo Les caravanes De La Besbre" style="height:160px " class="img-fluid logo "></div> 

      <div class=" col navbar-brand fs-2 textLogo" href="#">Les Caravanes De La Besbre <span class="orange">.</span></div> 
      
   <div class="col">   <img src="../images/papillons.gif" alt="Papillons" style="height:100px " class="img-fluid">
    </div>
