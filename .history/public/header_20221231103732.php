...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  ...
  <div class="row">  
    <div class="col p-0"><img src="../images/logo.png" alt="Logo" width="150" height="130" class="d-inline-block align-text-top "></div>
  <div class="col"><a class="navbar-brand p-3 fs-2   " href="#">Les Caravanes De La Besbre <span class="orange">.</span></a></div>
    ...
    <div class="collapse navbar-collapse justify-content-end custom-line sticky-bottom row " id="navbarNav">
      <ul class="navbar-nav fs-5 justify-content-between  col-6">
        <li class="nav-item">
