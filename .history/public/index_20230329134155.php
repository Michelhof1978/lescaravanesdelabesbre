...
// openPopup();
    ...
    <h1 class=" pb-2 text-center  border border-3 rounded  h1Index pt-1 text-white"><strong></strong> Location d'Hébergements à proximité Du parc D'Attractions Le Pal Dans L'Allier</h1>
