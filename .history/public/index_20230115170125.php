...
<p class="textIntro lead bg-light rounded shadow p-4 mb-5 bg-white rounded">
    Goûtez aux plaisirs du Camping sur un site exceptionnel, pleine nature, dans un cadre ombragé, de verdure et de calme situé au bord d’une rivière à Dompierre-sur-Besbre, proche des commerces. A proximité du Parc d'Attraction *le PAL* à moins de 10 minutes. Laissez-vous enchanter par notre ambiance caravane. Celles-ci sont en place du 03/07 au 28/08/2022 prévu pour 4 personnes (2 adultes, 2 enfants) tout confort et toutes équipées. Epicerie de base fournie (café, sucre, sel, poivre, huile, etc..). 
    Isabelle et son équipe se tiennent à votre disposition pour faire de votre séjour un moment inoubliable.
      ...
      <section class="text-center clear pt-5">
        <h4 class="mb-5 border border-3 rounded display-6 p-2 bg-light display-6"><strong>NOS PROPOSITIONS DE LOGEMENTS A PARTIR DE 78€/NUIT</strong></h4>
