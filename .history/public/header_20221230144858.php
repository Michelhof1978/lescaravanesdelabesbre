...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  ...
  <a class="navbar-brand fs-2 pb-4 col-5" href="#">Les Caravanes De La Besbre <span class="orange">.</span></a>

    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
      <span class="navbar-toggler-icon"></span>
    </button>
    <div class="collapse navbar-collapse row justify-content-end custom-line sticky-bottom " id="navbarNav">
      <ul class="navbar-nav col-6 fs-5 justify-content-between  ">
        <li class="nav-item">
