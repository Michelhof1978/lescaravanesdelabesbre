...
<nav class="navbar navbar-expand-md bg-body-tertiary">
  ...
  <div class="row">  
    <div></div><img src="../images/logo.png" alt="Logo" width="150" height="130" class="d-inline-block align-text-top "></div>
  <div><a class="navbar-brand  fs-2 pb-4 col-4 " href="#">Les Caravanes De La Besbre <span class="orange">.</span></a></div>
