...
<div class="container-fluid">
  ...
  <!-- Création hamburger en responsive -->
    ...
    <div class="collapse navbar-collapse  custom-line mx-5 position-absolute toptranslate-middle mt-1" id="navbarNav"><!-- id appel la fonction hamburger de boostrap aria-controls -->
