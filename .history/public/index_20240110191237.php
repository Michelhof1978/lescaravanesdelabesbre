...
<h4 class="m-5 text-center border border-3 rounded text-white p-2 display-6 h4Index" ><strong>VISITE AU PARC LE PAL</strong></h4>
  <div class="container">
    ...
    <div class="videoPal embed-responsive embed-responsive-16by9">
        <iframe width="560" height="315" src="<?php echo _URL; ?>" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
