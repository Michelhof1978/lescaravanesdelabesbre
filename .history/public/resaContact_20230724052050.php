...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $to = "votre@email.com"; // Remplacez cette adresse par votre adresse e-mail
    $sujet = "Confirmation de réception de votre formulaire de contact";
    $contenu = "Cher $nom,\n\nNous avons bien reçu votre message :\n\n$message\n\nNous vous remercions pour votre intérêt et nous vous répondrons dans les meilleurs délais.\n\nCordialement,\nVotre entreprise";

    $headers = "From: votre@email.com"; // Remplacez cette adresse par votre adresse e-mail
    mail($to, $sujet, $contenu, $headers);

    // Redirection vers une page de confirmation
    header("Location: confirmation.php"); // Créez une page "confirmation.php" pour afficher un message de confirmation
    exit();
}
?>
<!DOCTYPE html>
