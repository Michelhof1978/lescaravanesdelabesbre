    ...
    <div class="col-lg-4 col-md-12 mb-4 ">
      <div class="card ">
        ...
        <div class="card-body">
          ...
          <p class="card-text">
            Nous vous proposons une caravane tout confort équipée pour 4 personnes (2 adultes et 2 enfants), avec un auvent, sur un emplacement du <str>Camping "Les Bords de la Besbre"</str<br>
