      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p><strong>OU</strong></p>
            <a href="<?php echo AIRBNB1_URL; ?>https://www.airbnb.fr/rooms/34376099?check_in=2023-07-07&check_out=2023-07-09&guests=1&adults=2&s=13&unique_share_id=0e8b24e2-1835-49a1-a4a3-18082f186b0a&source_impression_id=p3_1673810303_FnHo0G0d1awJpqSg" target="_blank" class="btn btn-primary">Réservez Sur Airbnb (Tarifs Majorés de 20%) !</a>
          </div>
        </div>
      </div>
