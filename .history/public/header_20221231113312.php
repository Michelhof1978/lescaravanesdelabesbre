...
<div class="container-fluid">
  ...
  <!-- Création hamburger en responsive -->
    ...
    <div class="row">
    <div class="collapse navbar-collapse  custom-line " id="navbarNav"><!-- id appel la fonction hamburger de boostrap aria-controls -->
      <ul class="navbar-nav fs-5  nav justify-content-end col-12">
        <li class="nav-item">
