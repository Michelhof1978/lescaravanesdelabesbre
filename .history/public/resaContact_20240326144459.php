...
// Récupération de l'élément input du numéro de téléphone à partir de son ID
    let phoneNumberInput = document.getElementById("phoneNumber");//document.getElementById() est une fonction JavaScript qui permet de récupérer un élément HTML à partir de son attribut id
