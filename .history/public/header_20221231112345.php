...
<div class="container-fluid">
  ...
  <!-- Création hamburger en responsive -->
    ...
    <div class="row">
    <div class="collapse navbar-collapse justify-content-end justify-content-between custom-line sticky-bottom " id="navbarNav"><!-- id appel la fonction hamburger de boostrap aria-controls -->
