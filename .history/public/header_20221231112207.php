...
<div class="container-fluid">
  ...
  <!-- Création hamburger en responsive -->
    ...
    <div class="row">
    <div class="collapse navbar-collapse justify-content-end custom-line sticky-bottom " id="navbarNav"><!-- id appel la fonction hambuerger de boostrap aria-controls -->
