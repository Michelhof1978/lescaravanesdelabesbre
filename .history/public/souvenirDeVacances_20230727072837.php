...
<div class="container mt-5 mb-5">
    <div class="row">
        ...
        <div class="col-lg-6">
            ...
            <div>
                <img src="../images/festi03.webp" alt="concert festiDomp" class="videoPal embed-responsive embed-responsive-16by9  img-fluid mb-5 text-center w-75" />
                <img src="../images/festi02.webp" alt="concert festiDomp" class="videoPal embed-responsive embed-responsive-16by9 m img-fluid mb-5 text-center w-75" />
            </div>
        </div>
    </div>
</div>
