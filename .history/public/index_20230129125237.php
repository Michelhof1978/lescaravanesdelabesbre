<?php include("header.php") ?>
    ...
    <h1 class=" pb-2 text-center  border border-3 rounded bg-success h1Index pt-1 text-white bg-gradient" style="background: linear-gradient(to right, #4b6cb7, #182848);"> Location d'Hèbergements Proche Du parc D'Attraction Le Pal Dans L'Allier</h1>
    ...
    Isabelle et son équipe se tiennent à votre disposition pour faire de votre séjour un moment inoubliable.
      ...
      <section class="text-center clear mt-1 ms-2 me-2">
        <h4 class="mb-5 border border-3 rounded display-6 p-2 bg-info col m-2 h4Index text-white"><strong>LOCATIONS A PARTIR DE 78€/NUIT</strong></h4>
...
<h4 class="mb-4 carouseTitle border border-3 rounded bg-info p-2 display-6  m-2 text-center text-white">VENEZ DECOUVRIR LA BEAUTE DE LA CAMPAGNE</h4>
...
<section>
      ...
      <section class="mb-5 ms-2 me-2">
        <h4 class="m-5 text-center border border-3 rounded bg-info  text-white p-2 display-6" id="contact"><strong>NOUS CONTACTER</strong></h4>
