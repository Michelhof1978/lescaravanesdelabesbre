        ...
        <div class="row d-flex justify-content-center">
          <div class="col-md-6">
              ...
              <div class="row mb-4">
                ...
                <div class="col">
                  <div class="form-outline">
                    <input type="text" id="text" class="form-control"placeholder="Prénom" />
                ...
                <div class="col">
                  <div class="form-outline">
                    <input type="tel" id="phoneNumber" class="form-control" placeholder="Téléphone" />
              ...
              <div class="form-floating ">
                <textarea class="form-control " id="floatingTextarea message"></textarea>
              ...
              <!-- Submit button -->
              <input type="submit" class="btn btn-primary btn-block mb-4 mt-5">
                Envoyez
              </input>
