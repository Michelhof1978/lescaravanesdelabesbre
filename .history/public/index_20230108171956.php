...
<section>
  ...
  <main class="mt-3">
    <div class="container">
      ...
      <div class=" col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 embed-responsive embed-responsive-16by9">
        ...
        <div class="col-xs-14 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-center logoBilletGroup"> 
          <h3 class="billeterie text-dark ">Billeterie 
            <a href="https://www.lepal.com/"> 
            <img src="../images/lePal.png" class="achatBillet img-fluid " />
          </h3> 
          </a> 
        </div>
