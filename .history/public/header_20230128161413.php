...
<div id="mainNavigation">
  ...
  <div class="navbar-expand-md">
    <div class=" text-center my-2 ">
      <button class="navbar-toggler w-75 text-dark" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon hamburger "<i class="fas fa-bars" style="color:#fff; font-size:28px;"></i>></span> <span class="align-middle">Menu</span>
      </button>
    </div>
