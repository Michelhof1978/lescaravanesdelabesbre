    ...
    <div class="col-lg-4 col-md-12 mb-4">
      <div class="card">
        ...
        <div class="card-body">
         ...
         <br> <p>Option d'hébergement sous le auvent, permettant d'accueillir 2 personnes supplémentaires pour 12,00 € par personne (matelas non fournis, veuillez prévoir).</p></p>
        </p>
