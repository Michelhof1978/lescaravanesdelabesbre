<?php include("header.php") ?>
  ...
  <div class="carousel-indicators">
    ...
    <button type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide-to="" aria-label="Slide 3"></button>
  </div>
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      ...
      <div class="carousel-item">
      <img src=" ../images/nature.jpg" class="d-block w-100 h-50" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <h5>cdkdnkleejdlklakk</h5>
        <p>akdjjkahdajdijojddokpodk</p>
      </div>
