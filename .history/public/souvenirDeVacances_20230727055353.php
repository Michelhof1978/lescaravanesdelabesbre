...
<h1 class="pb-2 text-center  border border-3 rounded  h1Index pt-1 text-white mt-5">Souvenirs De Vacance</h1>
        ...
        <div class="row"> <!-- Nouvelle div avec la classe "row" pour placer les blocs container côte à côte -->

<container class="mt-5 mb-5">
    <div class="text-center row">
        <div class="col-lg-6"> <!-- La première colonne du premier bloc -->
...
<container class="col-lg-6"> <!-- La deuxième colonne du deuxième bloc -->
    <div class="row">
        <div class="col-lg-6">
