...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  ...
  <div class="row">  
    <div class="d-inline-block align-text-top col-xl-4"><img src="../images/logo.png" alt="Logo" width="150" height="130" ></div>
  <div class="navbar-brand pb-3 fs-2  col-xl-8 " href="#">Les Caravanes De La Besbre <span class="orange">.</span></div>
